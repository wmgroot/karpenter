...
type Disruption struct {
	...
	//
	// Warning: this takes precedence over a Pod's terminationGracePeriodSeconds value, and bypasses any blocked PDBs or the karpenter.sh/do-not-disrupt annotation.
	//
	// This field is intended to be used by cluster administrators to enforce that nodes can be cycled within a given time period.
	// When set, nodes may be disrupted for expiration or drift, regardless of karpenter.sh/do-not-disrupt annotations or PDBs set on pods.
